[redis-om](../README.md) / WhereHashBoolean
...
- [matches](WhereHashBoolean.md#matches)
...
[lib/search/where-boolean.ts:24](https://github.com/redis-developer/redis-om-node/blob/d4db235/lib/search/where-boolean.ts#L24)
