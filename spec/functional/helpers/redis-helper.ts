...
export async function fetchJsonData(client: Client, key: string): Promise<string> {
...
export async function fetchHashData(client: Client, key: string): Promise<Array<string>> {
  return <Array<string>>await client.execute(['HGETALL', key])
}
