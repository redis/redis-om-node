  ...
  describe('#query', () => {
    ...
    describe.each([
      ...
      it('generates a query with .is.greaterThanOrEqualTo', () =>
        expectToBeGTEQuery(where.is.greaterThanOrEqualTo(aDate)))
      it('generates a query with .is.not.greaterThanOrEqualTo', () =>
        expectToBeNegatedGTEQuery(where.is.not.greaterThanOrEqualTo(aDate)))
      ...
      it('generates a query with .is.not.lessThanOrEqualTo', () =>
        expectToBeNegatedLTEQuery(where.is.not.lessThanOrEqualTo(aDate)))
      ...
      it('generates a query with .not.between', () =>
        expectToBeNegatedBetweenQuery(where.not.between(ANOTHER_DATE, aDate)))
      ...
      it('generates a query with .is.not.between', () =>
        expectToBeNegatedBetweenQuery(where.is.not.between(ANOTHER_DATE, aDate)))
    })
  })
})
